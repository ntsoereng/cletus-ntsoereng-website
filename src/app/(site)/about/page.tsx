          ...
          <div key={data._id}>
            <section className="grid lg:grid-cols-2 grid-cols-1 gap-x-6 justify-items-center">
              <div className="order-2 lg:order-none">
                <h1 className="lg:text-2xl text-xl lg:leading-tight basis-1/2 font-bold mb-4">
                  I&apos;m {data.fullName}, based in {data.location}, from
                  whence I work my keyboard magic!
                </h1>
              ...
              <div className="flex flex-col lg:justify-self-center justify-self-center gap-y-1 lg:order-1 order-none mb-2">
                <div>
                  <Image
                    className="rounded-2xl mb-4 object-cover max-h-96 min-h-96 bg-top bg-firstColor"
                ...
                <ul className="mb-4">
                  <li>
                    <a
                      ...
                      className="flex items-center justify-center gap-x-2 hover:text-firstColor duration-300"
                    >
            ...
            <section className="mt-6 max-w-2xl">
              <h2 className="lg:text-2xl text-xl lg:leading-tight basis-1/2 font-bold mb-4">
                My Expertise
              </h2>
