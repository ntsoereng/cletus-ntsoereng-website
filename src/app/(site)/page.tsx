          ...
          {profile &&
            profile.map((data) => (
              <div key={data._id} className="lg:max-w-2xl max-w-2xl">
                <h1 className="text-3xl font-semibold tracking-tight sm:text-3xl mb-2 lg:leading-[3.7rem] leading-tight lg:min-w-[700px] min-w-full">
                  {data.headline}
                </h1>
                    ...
                    .map(([key, value], id) => (
                      <li key={id}>
                        <a
                          ...
                          className="flex items-center gap-x-3 rounded mb-5 px-2 py-1 hover:bg-firstColor hover:text-white duration-300 tracking-wider"
                        >
