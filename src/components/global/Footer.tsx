...
export default function Footer() {
  return (
    <footer className="pt-12 mt-10 max-w-6xl lg:px-16 px-6 mx-auto">
      <div className="pt-10 grid md:place-content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mb-16">
        <div className="mb-4">
          <h4 className="text-xl font-semibold tracking-wider text-slate-800 dark:text-whiteColor mb-4">
        ...
        <div>
          <div className="mb-4">
            ...
            <div className="flex gap-4 items-center text-md mb-3 text-gray-500 dark:text-gray-400">
            ...
            <div className="flex gap-4 items-center text-md mb-3 text-gray-500 dark:text-gray-400">
              ...
              <span>(266) 5754 0890</span>
            </div>
          </div>
        </div>
        <div className="flex flex-col gap-2">
          <h4 className="text-xl font-semibold tracking-wider text-slate-800 dark:text-whiteColor">
