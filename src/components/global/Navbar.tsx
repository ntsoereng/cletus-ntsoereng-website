...
export default function Navbar() {
  ...
  return (
    <header className="shadow-lg h-[calc(var(--header-height)+1rem)] w-full fixed top-0 left-0 py-0 px-6 lg:py-2 z-100 flex justify-between items-center dark:bg-darkColor/70 bg-white-500/70 backdrop-blur-md">
      ...
      <nav
        className={`transition-all lg:w-full max-lg:fixed max-lg:top-0 max-lg:py-2 lg:py-2 ${
